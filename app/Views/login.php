...
<body>
    <form action="check_login" class="form-login" method="post">
        ...
        <p class="form-login__heading">Login</p>
        <div class="form-login__input-container">
            ...
            <input type="text" class="form-login__input-field" id="jls_username" name="jls_username" placeholder="Username">
        </div>
        ...
        <div class="form-login__input-container">
            ...
            <input type="password" class="form-login__input-field" id="jls_user_password" name="jls_user_password" placeholder="Password">
        </div>


        <button id="form-login__button">Submit</button>
        <a class="form-login__forgot-link" href="#">Forgot your password?</a>
    </form>
