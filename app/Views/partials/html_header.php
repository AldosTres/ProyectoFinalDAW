...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>css/tournament_info.css">
    ...
    <!-- Logotipo -->
    <link rel="icon" type="<?= base_url() ?>img/logoTipoLeagueSeries-removebg-preview.png" href="/images/favicon.ico">
